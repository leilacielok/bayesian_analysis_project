...
Convergence is assessed using graphical diagnostics (trace plots and autocorrelation functions) and numerical diagnostics, including the Geweke statistic and the effective sample size.
